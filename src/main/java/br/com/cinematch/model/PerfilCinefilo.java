...
public class PerfilCinefilo {
    ...
    public void setPesoGenero(Genero genero, double peso) {
        ...
        pesosPorGenero.put(Objects.requireNonNull(genero), peso);
    }
    ...
    public void marcarComoAssistido(String filmeId) {
        historicoAssistidos.add(Objects.requireNonNull(filmeId));
    }
    ...
    public boolean estaCompleto() {
        return classificacaoMaxima != null
                && !idiomasAceitos.isEmpty()
